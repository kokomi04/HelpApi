...
namespace HelpApi
{
    public class Startup
    {
        ...
        private void ConfigureBussinessService(IServiceCollection services)
        {
            ...
            services.AddScoped<IGuideCateService, GuideCateService>();
        ...
        private void ConfigureAuthService(IServiceCollection services)
        {
            ...
            services.AddAuthentication(options =>
                ...
                {
                    options.Authority = "https://test-app.verp.vn/endpoint/token";
                ...
                {
                    options.Authority = "https://test-app.verp.vn/endpoint";
